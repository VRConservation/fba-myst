...
- **Connecting pilot to commercial scales**. Bridging the capital and operational gap between pilot-scale and commercial-scale production requires strategic planning, e.g., co‑locating with energy partners and securing early letters of intent from offtake partners to materially de‑risk capex and smooth early cash flow.
